{
  ...
  gROOT->LoadMacro("CreateAlienHandlerTerminateSim.C");
...
//  TChain* chain = CreateESDChain("ESD82XX_30K.txt", 10);
  ...
  AliAnalysisDataContainer *coutput1 = mgr->CreateContainer("out1", TList::Class(), AliAnalysisManager::kOutputContainer,"Et.ESD.sim.new.root");
